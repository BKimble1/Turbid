...
/// The home screen: what Lucid does, camera permission, the measurement mode,
...
struct RootView: View {
    ...
    private var whatLucidDoes: some View {
        SectionCard(title: "What Lucid does", systemImage: "flashlight.on.fill") {
            VStack(alignment: .leading, spacing: Theme.Spacing.sm) {
                ...
                Button("Read what Lucid can and cannot tell you") {
