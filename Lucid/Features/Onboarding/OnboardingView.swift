...
/// The first thing anyone sees: what Lucid measures, and what it does not.
///
...
struct OnboardingView: View {
    ...
    private var whatItMeasures: some View {
        SectionCard(title: "What Lucid measures", systemImage: "flashlight.on.fill") {
            VStack(alignment: .leading, spacing: Theme.Spacing.sm) {
                Text("Lucid turns the torch on, watches how much light a water sample scatters back to the camera, and tracks visible specks drifting through a small region of the frame.")
                    .font(.subheadline)
                    .foregroundStyle(Theme.Palette.primaryText)
    ...
    private var whatItCannotDetect: some View {
        SectionCard(title: "What Lucid cannot tell you", systemImage: "exclamationmark.shield") {
            VStack(alignment: .leading, spacing: Theme.Spacing.sm) {
    ...
    private var modes: some View {
        SectionCard(title: "Why there is usually no NTU number",
            ...
            VStack(alignment: .leading, spacing: Theme.Spacing.md) {
                Text("NTU is the unit a laboratory turbidity meter reports. An iPhone is not one: it has no calibrated light source, no fixed sample geometry and no defined detection angle. Lucid will only show an NTU value when it has been calibrated against certified standards on the exact setup being used.")
                    .font(.subheadline)
                    .foregroundStyle(Theme.Palette.primaryText)
    ...
    private var acknowledgement: some View {
        VStack(alignment: .leading, spacing: Theme.Spacing.md) {
            Text("I understand that Lucid measures optical clarity only, and does not tell me whether water is safe to drink.")
                .font(.subheadline)
                .foregroundStyle(Theme.Palette.primaryText)
