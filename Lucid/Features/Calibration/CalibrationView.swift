...
/// suspected carcinogen. Lucid never explains how to prepare a standard and
...
struct CalibrationView: View {
    ...
    private var safetyNotice: some View {
        VStack(alignment: .leading, spacing: Theme.Spacing.sm) {
            ...
            Text("Never attempt to prepare formazin yourself. It is made from hydrazine sulfate, which is acutely toxic and a suspected carcinogen. Lucid does not provide preparation instructions.")
            ...
            VStack(alignment: .leading, spacing: Theme.Spacing.md) {
                if library.profilesNewestFirst.isEmpty {
                    EmptyStateView(
                        ...
                        message: "Without one, Lucid reports optical clarity but no NTU value."
                    )
                } else {
