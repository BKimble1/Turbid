    ...
    private var setupStep: some View {
        VStack(alignment: .leading, spacing: Theme.Spacing.md) {
            SectionCard(
                ...
                systemImage: "cube",
                footnote: "A calibration belongs to one physical arrangement. If any of this changes, the calibration no longer describes it and Turbid will refuse to use it."
            ) {
            ...
            VStack(alignment: .leading, spacing: Theme.Spacing.md) {
                SectionCard(title: "Calibration saved", systemImage: "checkmark.seal.fill") {
                    VStack(alignment: .leading, spacing: Theme.Spacing.sm) {
                        ...
                        Text("Switch to Calibrated Fixture Mode on the main screen to use it. Turbid will still refuse to show NTU if anything about the setup has changed.")
                            .font(.caption)
                            .foregroundStyle(Theme.Palette.secondaryText)
                    }
                }
